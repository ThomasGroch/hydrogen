...
echo form_open($this->ctrlr_name . "/add_address/" . $items->id, '', $hidden);
...
?>
    ...
    <div class="clearfix <?php if(form_error('address1') != '' ){ echo 'error'; } ?>">	
        ...
        <div class="input"><?php echo form_input(array('id' => 'adress1','name' => 'address1', 'value' => set_value('address1'))); ?></div>
